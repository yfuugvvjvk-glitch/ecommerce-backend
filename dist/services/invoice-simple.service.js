...
exports.InvoiceSimpleService = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
class InvoiceSimpleService {
    ...
    async getInvoiceForOrder(orderId, userId) {
    ...
    async getInvoiceForOrderAdmin(orderId) {
        const order = await prisma.order.findUnique({
            where: { id: orderId },
            include: {
                user: true,
...
<body>
  ...
  <div class="footer">
    ...
    // Duplică o factură
    async duplicateInvoice(orderId) {
...
exports.InvoiceSimpleService = InvoiceSimpleService;
