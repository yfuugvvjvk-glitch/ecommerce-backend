...
exports.userCardService = exports.UserCardService = void 0;
...
class UserCardService {
    ...
    async addRealCard(userId, cardData) {
        try {
    ...
    async refundPayment(userId, orderId) {
        try {
...
exports.userCardService = new UserCardService();
